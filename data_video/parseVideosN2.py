...
classes = ['-', 'A', 'E', 'I', 'O', 'U']
#class processing
start_class_processing = 6
max_class_processed = 6
#train nodes
first_node = [0, 0, 0, 0, 0, 13]
...
for TargetLetter in classes:
    ...
    for path in sorted(glob(image_path + "*.*")):
        ...
        parseVideo(path, destDirectories=base_letter_paths,fileDirectories=fileDirectoryList, train_max_frame=500, train_max_low_frame=100)
