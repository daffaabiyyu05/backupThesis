...
#train nodes
first_node = [0, 0, 0, 0, 0, 0]
last_node = [22, 25, 21, 21, 20, 20]
    
TrainPath = BasePath + "train\\"
TestPath = BasePath + "test\\"

ImageDatasetFolder = "DatasetBN"
...
for TargetLetter in classes:
    ...
    image_path = "./" + ImageDatasetFolder +"/" + TargetLetter + '/'
    ...
    for path in sorted(glob(image_path + "*.*")):
        ...
        parseVideo(path, destDirectories=base_letter_paths,fileDirectories=fileDirectoryList, train_max_frame=500, train_max_low_frame=150)
