...
for TargetLetter in classes:
    ...
    image_path = "./DatasetB/" + TargetLetter + '/'
    ...
    for path in sorted(glob(image_path + "*.*")):
        ...
        parseVideo(path, destDirectories=base_letter_paths,fileDirectories=fileDirectoryList, train_max_frame=150, train_max_low_frame=30)
